...
export const statement =
  'Expense claims arrive in the finance inbox as ordinary emails, written however the claimant felt like writing them. Build a flow that reads each claim and decides between three outcomes. Approve it on the spot, send it to a manager for sign off, or send it back. Finance policy: a claim under 5,000 rupees with an amount, a date and a reason is approved automatically. Anything from 5,000 up needs a manager. Every outcome replies to the person who submitted the claim, and each reply says something different.';
