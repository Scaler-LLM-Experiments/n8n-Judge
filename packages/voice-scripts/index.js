...
import leadTriage from './lead-triage.json' with { type: 'json' };
import meetingNotes from './meeting-notes.json' with { type: 'json' };
import orderDesk from './order-desk.json' with { type: 'json' };

/** Every problem's clip table, by slug. */
export const voiceScripts = {
  'email-triage': emailTriage,
  'lead-triage': leadTriage,
